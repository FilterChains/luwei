...
/**
 * <p>@description : 凯撒加密演变->维吉尼亚加密 </p>
 * <p>@author : Wei.Lu</p>
 * <p>@date : 2020/12/14 17:10 </p>
 *
 **/
public class VirginiaAlgorithm {
    ...
    public static void main(String[] args) {
        ...
        String virginiaEncode = virginiaEncode(str,secretKey);
        System.out.println("密文:"+virginiaEncode);

        String virginiaDecode = virginiaDecode(virginiaEncode, secretKey);
        System.out.println("解密:"+virginiaDecode);
    ...
    private static List<Integer> getSecretKeyList(char[] secretCharArray, int length) {
        ...
        if(list.size()>length) {
            ...
            if(mold>0) {
                list.addAll(Arrays.asList(keyArray).subList(0, mold));
