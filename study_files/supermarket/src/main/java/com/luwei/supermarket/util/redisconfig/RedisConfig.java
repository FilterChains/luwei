...
public class RedisConfig extends CachingConfigurerSupport {
     ...
     * @Return: HashOperations<String ,   String ,   Object>  返回类型
     ...
     * @Param: [redisTemplate]   参数
     * @Return: ValueOperations<String ,   Object> 返回类型
     * @Date: 2020/1/24 22:58
     */
    @Bean
     ...
     * @Param: [redisTemplate]   参数
     * @Return: ListOperations<String ,   Object>  返回类型
     * @Date: 2020/1/24 22:58
     */
    @Bean
     ...
     * @Param: [redisTemplate]   参数
     * @Return: SetOperations<String   ,       Object>    返回类型
     ...
     * @Param: [redisTemplate]   参数
     * @Return: ZSetOperations<String   ,       Object> 返回类型
