...
public class PushParams implements Serializable {
    ...
    public enum IosAppKey {
        ...
        CLOUD_MEDICINE_IOS("CLOUD_MEDICINE_IOS", "云采医药_iosAppKey"),
        CLOUD_STEWARD_IOS("CLOUD_STEWARD_IOS", "云采管家_iosAppKey");
    ...
    public enum AndroidAppKey {
        ...
        CLOUD_MEDICINE_ANDROID("CLOUD_MEDICINE_ANDROID", "云采医药_androidAppKey"),
        CLOUD_STEWARD_ANDROID("CLOUD_STEWARD_ANDROID", "云采管家_androidAppKey");
